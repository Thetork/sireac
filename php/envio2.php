...
date_default_timezone_set('America/Mexico_City');
    ...
    $cancelacion = htmlspecialchars(trim($_POST['cancelacion_2']));
    $cancelacion_1 = utf8_decode($cancelacion);

    $total_1_1 = trim($_POST['total_1_2']);
    $mujeres_1_1 = trim($_POST['mujeres_1_2']);
    $hombres_1_1 = trim($_POST['hombres_1_2']);
    $otros_1_1 = trim($_POST['otros_1_2']);

    $total_2_1 = trim($_POST['total_2_2']);
    $mujeres_2_1 = trim($_POST['mujeres_2_2']);
    $hombres_2_1 = trim($_POST['hombres_2_2']);
    $otros_2_1 = trim($_POST['otros_2_2']);

    $total_3_1 = trim($_POST['total_3_2']);
    $mujeres_3_1 = trim($_POST['mujeres_3_2']);
    $hombres_3_1 = trim($_POST['hombres_3_2']);
    $otros_3_1 = trim($_POST['otros_3_2']);

    $total_4_1 = trim($_POST['total_4_2']);
    $mujeres_4_1 = trim($_POST['mujeres_4_2']);
    $hombres_4_1 = trim($_POST['hombres_4_2']);
    $otros_4_1 = trim($_POST['otros_4_2']);

    $total_5_1 = trim($_POST['total_5_2']);
    $mujeres_5_1 = trim($_POST['mujeres_5_2']);
    $hombres_5_1 = trim($_POST['hombres_5_2']);
    $otros_5_1 = trim($_POST['otros_5_2']);

    $total_6_1 = trim($_POST['total_6_2']);
    $mujeres_6_1 = trim($_POST['mujeres_6_2']);
    $hombres_6_1 = trim($_POST['hombres_6_2']);
    $otros_6_1 = trim($_POST['otros_6_2']);

    $total_7_1 = trim($_POST['total_7_2']);
    $mujeres_7_1 = trim($_POST['mujeres_7_2']);
    $hombres_7_1 = trim($_POST['hombres_7_2']);
    $otros_7_1 = trim($_POST['otros_7_2']);

    $total_8_1 = trim($_POST['total_8_2']);
    $mujeres_8_1 = trim($_POST['mujeres_8_2']);
    $hombres_8_1 = trim($_POST['hombres_8_2']);
    $otros_8_1 = trim($_POST['otros_8_2']);

    $rango_1_1 = trim($_POST['rango_1_2']);
    $rango_2_1 = trim($_POST['rango_2_2']);
    $rango_3_1 = trim($_POST['rango_3_2']);
    $rango_4_1 = trim($_POST['rango_4_2']);
    $rango_5_1 = trim($_POST['rango_5_2']);
    $rango_6_1 = trim($_POST['rango_6_2']);
    $rango_7_1 = trim($_POST['rango_7_2']);
